...
- [ ] Explain what a token is used for.
    tokes are used for authentication. Without it, the user may not have permission to access protected areas.

- [ ] What steps can you take in your web apps to keep your data secure?
  Create a Login Page to provide users tokens.
  PrivateRoutes
...
- [ ] Describe how web servers work.
    Hardware
      Stores Files, deliver files on request
    Software
      Fetch Code, Display It
